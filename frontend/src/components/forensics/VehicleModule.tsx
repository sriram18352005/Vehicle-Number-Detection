...
export function VehicleModule() {
    ...
    return (
        <div className="vehicle-module space-y-4">
            ...
            <div className="mode-switcher">
                <button className={`mode-btn ${mode === 'single' ? 'active' : ''}`} id="btn-single" onClick={() => setMode('single')}>
                ...
                <button className={`mode-btn ${mode === 'batch' ? 'active' : ''}`} id="btn-batch" onClick={() => setMode('batch')}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    {batchStatus !== 'idle' && (
                        <div className="mt-8">
                            <div className="flex justify-between items-end mb-4">
                                ...
                                {batchStatus === 'complete' && <button className="csv-btn" onClick={exportCSV}>Export CSV</button>}
                            </div>
                                ...
                                <table className="batch-table">
                                    <thead>
                                        <tr>
                                            <th>File Name</th>
                                            <th>CHASSIS</th>
                                            <th style={{ fontSize: 9, fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: '#4a5568', padding: '14px 16px' }}>MANUFACTURER</th>
                                            <th>REGISTRATION</th>
                                            <th>STATE</th>
                                            <th>CONFIDENCE</th>
                                            <th>STATUS</th>
                                                            ...
                                                            <td colSpan={7} style={{ padding: 0, background: '#070a10' }}>
                                                                <div style={{ padding: '20px 24px', borderTop: '1px solid #1e2535', borderBottom: '1px solid #1e2535', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                                                                    <div style={{ background: '#0d1020', border: '1px solid #1e2535', borderRadius: 10, padding: '16px 20px' }}>
                                                                        ...
                                                                        {row.chassis ? (
                                                                            <React.Fragment>
                                                                                <div style={{ fontFamily: 'Courier New, monospace', fontSize: 16, fontWeight: 700, color: row.status === 'invalid' ? '#ff5252' : '#00e676', letterSpacing: 1, marginBottom: 10, textDecoration: row.status === 'invalid' ? 'line-through' : 'none' }}>
                                                                                    {row.chassis}
                                                                                </div>
                                                                                {row.status !== 'invalid' && (
                                                                                    <React.Fragment>
                                                                    ...
                                                                    <div style={{ background: '#0d1020', border: '1px solid #1e2535', borderRadius: 10, padding: '16px 20px' }}>
                                                                        ...
                                                                        {row.registration ? (
                                                                            <React.Fragment>
                                                                                <div style={{ fontFamily: 'Courier New, monospace', fontSize: 16, fontWeight: 700, color: '#00e676', letterSpacing: 2, marginBottom: 10 }}>{row.registration}</div>
